...
if(NOT CIMG_H_DIR)
    ...
    set(PNG_STATIC_LIBRARY ${libpng_STATIC_LIBRARIES})
    set(JPEG_STATIC_LIBRARIES ${libjpeg_STATIC_LIBRARIES})
    set(PNG_LIBRARY ${libpng_LINK_LIBRARIES})
    set(JPEG_LIBRARIES ${libjpeg_LINK_LIBRARIES})

    set(CImg_INCLUDE_DIR ${CIMG_H_DIR} CACHE STRING "")
    set(CImg_INCLUDE_DIRS ${CImg_INCLUDE_DIR})
    set(CImg_STATIC_LIBRARIES "${PNG_STATIC_LIBRARY};${JPEG_STATIC_LIBRARIES}")
    ...
    if(NOT TARGET CImgStatic)
        add_library(CImgStatic INTERFACE)
        set_property(TARGET CImgStatic PROPERTY INTERFACE_INCLUDE_DIRECTORIES "${CIMG_H_DIR};${PNG_INCLUDE_DIR};${JPEG_INCLUDE_DIR}")
        set_property(TARGET CImgStatic PROPERTY INTERFACE_LINK_LIBRARIES "${CImg_STATIC_LIBRARIES}")
        set_property(TARGET CImgStatic PROPERTY INTERFACE_COMPILE_DEFINITIONS "${CImg_DEFINITIONS}")
    endif()
endif()
